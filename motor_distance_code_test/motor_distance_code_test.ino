...
static struct pt getgyroPT, getdistancePT, getcurrentPT, getnewinputPT, forwardrunPT, backwardrunPT, stoprunPT, gofrontPT, gomiddlePT, gobackPT, lowbattPT;    // decalring protothreads  //getpromptPT,

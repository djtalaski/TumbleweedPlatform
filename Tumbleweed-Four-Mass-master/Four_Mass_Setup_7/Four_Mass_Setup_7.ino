...
#define SP_angvel                60.00f  // deg/s                  (60 = 10rpm)  (90 = 15rpm)
...
void continuous_setpoint_from_angle(pidInfo &pid1, pidInfo &pid2, pidInfo &pid3, pidInfo &pid4, angleData &data)
{
	...
	{
		pid1.sp = SP_mean + 15*cos(data.curr_angle*3.14159/180);
        pid2.sp = SP_mean - 15*cos(data.curr_angle*3.14159/180);;
        pid3.sp = SP_mean + 15*sin(data.curr_angle*3.14159/180);; // assume pid1 is left motor and up
        pid4.sp = SP_mean - 15*sin(data.curr_angle*3.14159/180);;
        pid1.i = 0;
        pid1.pe = 0;
        pid2.i = 0;
        pid2.pe = 0;
